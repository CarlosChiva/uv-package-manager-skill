# carloschiva Agent Skills

This repository contains a collection of agent skills for carloschiva. These skills are designed to enhance the capabilities of agents by providing them with specialized functionalities.
...
| Skill | Description |
| ----- | ----------- |
| [uv-manager](./skills/uv-manager) | Have information how to use uv package manager |
...
npx skills add carloschiva/agent-skills --skill uv-manager
...
/plugin add carloschiva/agent-skills
```
...
```bash
node scripts/add-skill.js uv-manager "Have information how to use uv package manager"
```
